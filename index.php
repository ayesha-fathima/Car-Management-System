    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="i1.jpg" class="d-block w-100" style="height: 550px;" alt="...">
          </div>
          <div class="carousel-item">
            <img src="i2.jpg" class="d-block w-100" style="height: 550px;" alt="...">
          </div>
          <div class="carousel-item">
            <img src="i3.jpg" class="d-block w-100" style="height: 550px;" alt="...">
          </div>
        </div>
