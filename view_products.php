<?php
    ...
    $sql = "SELECT  product.product_id,customer.customer_id, product.p_name, product.MRP FROM customer INNER JOIN product ON customer.customer_id=product.customer_id" ;
